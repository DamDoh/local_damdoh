...
exports.scanRecoveryQr = exports.createRecoverySession = exports.lookupUserByPhone = exports.getUniversalIdData = exports.generateUniversalIdOnUserCreate = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const uuid_1 = require("uuid");
const profiles_1 = require("./profiles");
const crypto_1 = require("crypto"); // For generating a secret
 ...
 */
exports.generateUniversalIdOnUserCreate = functions.firestore
...
exports.getUniversalIdData = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const scannerRole = await (0, profiles_1.getRole)(scannerUid);
...
exports.lookupUserByPhone = functions.https.onCall(async (data, context) => {
    ...
    const agentRole = await (0, profiles_1.getRole)(agentUid);
...
exports.createRecoverySession = functions.https.onCall(async (data, context) => {
    ...
    const recoverySecret = (0, crypto_1.randomBytes)(16).toString('hex'); // A secret that the friend's app will send back
