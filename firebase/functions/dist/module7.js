...
exports.calculateDamDohCreditScore = functions.firestore
    ...
    try {
        ...
        const scoreResult = await (0, module8_1._internalAssessCreditRisk)(relevantData);
...
exports.matchFundingOpportunities = functions.firestore
    ...
    try {
        ...
        const matchedOpportunitiesResult = await (0, module8_1._internalMatchFundingOpportunities)({
...
exports.getFinancialSummaryAndTransactions = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        querySnapshot.forEach((doc) => {
            ...
            transactions.push(Object.assign(Object.assign({ id: doc.id }, tx), { timestamp: tx.timestamp.toDate().toISOString() }));
        });
        const summary = {
            totalIncome,
            totalExpense,
