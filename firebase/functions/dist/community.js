...
exports.voteOnPoll = exports.getCommentsForPost = exports.addComment = exports.likePost = exports.deletePost = exports.createFeedPost = void 0;
exports.deleteCollectionByPath = deleteCollectionByPath;
 ...
 */
async function deleteCollectionByPath(collectionPath, batchSize) {
...
exports.createFeedPost = functions.https.onCall(async (data, context) => {
    ...
    await newPostRef.set({
        ...
        likesCount: 0,
        commentsCount: 0,
        pollOptions: pollOptions ? pollOptions.map((opt) => ({ text: opt.text, votes: 0 })) : null,
    });
...
exports.deletePost = functions.https.onCall(async (data, context) => {
    ...
    const callerRole = await (0, profiles_1.getRole)(uid);
...
exports.getCommentsForPost = functions.https.onCall(async (data, context) => {
    ...
    const comments = commentsSnapshot.docs.map(doc => {
        ...
        return {
            ...
            timestamp: (_b = (_a = commentData.createdAt) === null || _a === void 0 ? void 0 : _a.toDate) === null || _b === void 0 ? void 0 : _b.call(_a).toISOString(),
        };
    });
...
exports.voteOnPoll = functions.https.onCall(async (data, context) => {
    const uid = checkAuth(context);
