...
exports.getAdminRecentActivity = exports.getAdminDashboardData = exports.getAgriTechInnovatorDashboardData = exports.getWasteManagementDashboardData = exports.getEquipmentSupplierDashboardData = exports.getCrowdfunderDashboardData = exports.getEnergyProviderDashboardData = exports.getInsuranceProviderDashboardData = exports.getAgroTourismDashboardData = exports.getAgronomistDashboardData = exports.getResearcherDashboardData = exports.getCertificationBodyDashboardData = exports.getQaDashboardData = exports.getWarehouseDashboardData = exports.getProcessingUnitDashboardData = exports.getAgroExportDashboardData = exports.getInputSupplierDashboardData = exports.getFieldAgentDashboardData = exports.getLogisticsDashboardData = exports.getRegulatorDashboardData = exports.getBuyerDashboardData = exports.getCooperativeDashboardData = exports.getFiDashboardData = exports.getPackagingSupplierDashboardData = exports.getFarmerDashboardData = void 0;
    ...
    try {
        ...
        const recentCrops = cropsSnapshot.docs.slice(0, 5).map(doc => {
            ...
            return {
                ...
                plantingDate: ((_b = (_a = cropData.plantingDate) === null || _a === void 0 ? void 0 : _a.toDate) === null || _b === void 0 ? void 0 : _b.call(_a).toISOString()) || null,
            };
        });
        const activeKnfBatches = knfBatchesSnapshot.docs
            ...
            return {
                ...
                startDate: (_b = (_a = batchData.startDate) === null || _a === void 0 ? void 0 : _a.toDate) === null || _b === void 0 ? void 0 : _b.call(_a).toISOString(),
                nextStepDate: (_d = (_c = batchData.nextStepDate) === null || _c === void 0 ? void 0 : _c.toDate) === null || _d === void 0 ? void 0 : _d.call(_c).toISOString(),
        ...
        const certifications = certsSnapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        return {
...
exports.getFiDashboardData = functions.https.onCall(async (data, context) => {
    ...
    try {
        const applicationsSnapshot = await db.collection('financial_applications')
            ...
            .limit(10)
            .get();
        const pendingApplications = applicationsSnapshot.docs.map(doc => {
            var _a, _b, _c;
            ...
            return {
                ...
                submittedAt: (_c = (_b = (_a = appData.submittedAt) === null || _a === void 0 ? void 0 : _a.toDate) === null || _b === void 0 ? void 0 : _b.call(_a).toISOString()) !== null && _c !== void 0 ? _c : null,
        ...
        const productsSnapshot = await db.collection('financial_products')
            .where('fiId', '==', fiId)
            .get();
        const financialProducts = productsSnapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        return {
            pendingApplications,
            portfolioOverview,
            financialProducts,
...
// =================================================================
exports.getCooperativeDashboardData = functions.https.onCall(async (data, context) => {
    var _a, _b;
    ...
    try {
        ...
        const groupId = (_a = coopData === null || coopData === void 0 ? void 0 : coopData.profileData) === null || _a === void 0 ? void 0 : _a.groupId;
        let memberCount = 0;
        let memberIds = [];
        if (groupId) {
            const groupDoc = await db.collection('groups').doc(groupId).get();
            if (groupDoc.exists) {
                memberCount = ((_b = groupDoc.data()) === null || _b === void 0 ? void 0 : _b.memberCount) || 0;
                const membersSnapshot = await db.collection(`groups/${groupId}/members`).get();
                memberIds = membersSnapshot.docs.map(doc => doc.id);
            }
        }
        let totalLandArea = 0;
        let aggregatedProduce = [];
        if (memberIds.length > 0) {
            ...
            const farmPromises = memberChunks.map(chunk => db.collection('farms').where('ownerId', 'in', chunk).get());
            const cropPromises = memberChunks.map(chunk => db.collection('crops')
            ...
            cropSnapshots.forEach(snapshot => {
                snapshot.forEach(doc => {
                    ...
                    aggregatedProduce.push({
                        ...
                        quantity: parseFloat(((_a = cropData.expectedYield) === null || _a === void 0 ? void 0 : _a.split(' ')[0]) || '0'),
                        quality: 'Grade A', // Placeholder as it's not on the crop model
                        readyBy: ((_c = (_b = cropData.harvestDate) === null || _b === void 0 ? void 0 : _b.toDate) === null || _c === void 0 ? void 0 : _c.call(_b).toISOString()) || new Date().toISOString(),
                    });
                });
            });
...
exports.getLogisticsDashboardData = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const activeShipments = shipmentsSnapshot.docs.map(doc => {
            var _a;
            const order = doc.data();
            const relatedVtiId = (_a = itemDetails[order.itemId]) === null || _a === void 0 ? void 0 : _a.relatedTraceabilityId;
            return {
                id: doc.id,
        ...
        const incomingJobs = jobsSnapshot.docs.map(doc => {
            ...
            return {
                id: doc.id,
                from: ((_a = sellerProfiles[order.sellerId]) === null || _a === void 0 ? void 0 : _a.location) || 'Unknown Origin',
                to: order.buyerLocation || 'Unknown Destination',
...
exports.getFieldAgentDashboardData = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const assignedFarmerIds = ((_a = agentData === null || agentData === void 0 ? void 0 : agentData.profileData) === null || _a === void 0 ? void 0 : _a.assignedFarmers) || [];
        let assignedFarmers = [];
    ...
    try {
        ...
        const packagingOrders = ordersSnapshot.docs.map(doc => {
            ...
            return {
                ...
                deliveryDate: ((_a = order.expectedDeliveryDate) === null || _a === void 0 ? void 0 : _a.toDate().toISOString()) || new Date(Date.now() + 86400000 * 5).toISOString(),
                status: order.status,
                actionLink: `/marketplace/my-orders/${order.id}`,
            };
        });
...
exports.getQaDashboardData = functions.https.onCall((data, context) => {
    checkAuth(context);
    return {
        pendingInspections: [
    ...
    try {
        ...
        const listedExperiences = experiencesSnapshot.docs.map(doc => {
            ...
            return {
                ...
                status: 'Published', // Assuming all listed items are published for now
    ...
    try {
        ...
        const pendingClaims = claimsSnapshot.docs.map(doc => {
            ...
            return {
                ...
                claimDate: claim.submittedAt.toDate().toISOString(),
                status: claim.status,
                actionLink: '#'
            };
        });
...
exports.getEnergyProviderDashboardData = functions.https.onCall((data, context) => {
    checkAuth(context);
    return {
        projectLeads: [
...
exports.getCrowdfunderDashboardData = functions.https.onCall((data, context) => {
    checkAuth(context);
    return {
...
exports.getEquipmentSupplierDashboardData = functions.https.onCall(async (data, context) => {
    const supplierId = checkAuth(context);
    try {
        ...
        const pendingMaintenanceRequests = []; // No data source for this yet
        return {
            listedEquipment,
            rentalActivity,
...
exports.getWasteManagementDashboardData = functions.https.onCall((data, context) => {
    checkAuth(context);
    return {
...
exports.getAgriTechInnovatorDashboardData = functions.https.onCall(async (data, context) => {
...
exports.getAdminRecentActivity = functions.https.onCall(async (data, context) => {
    checkAuth(context);
    try {
        ...
        listingsSnap.forEach(doc => {
            ...
            activities.push({
                ...
                timestamp: listing.createdAt.toDate().toISOString(),
