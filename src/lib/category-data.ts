...
export const AGRICULTURAL_CATEGORIES: CategoryNode[] = [
  ...
  { id: 'agronomy-consultancy', name: 'Agronomy & Consultancy', icon: GraduationCap, parent: 'services', href: '/talent-exchange?category=agronomy-consultancy', description: 'Expert advice, soil testing, crop planning by agronomists & consultants.' },
  ...
  { id: 'storage-warehousing', name: 'Storage & Warehousing', icon: Warehouse, parent: 'services', href: '/talent-exchange?category=storage-warehousing', description: 'Rent space in a warehouse or silo for your produce.' },
  ...
  { id: 'land-services', name: 'Land Services (Lease/Plotting)', icon: LandPlot, parent: 'services', href: '/talent-exchange?category=land-services', description: 'Lease agricultural land or find plotting services.' },
  { id: 'training-education-services', name: 'Training & Education Services', icon: GraduationCap, parent: 'services', href: '/talent-exchange?category=training-education-services', description: 'Specialized training courses and educational workshops.' },
  { id: 'surveying-mapping-services', name: 'Surveying & Mapping Services', icon: DraftingCompass, parent: 'services', href: '/talent-exchange?category=surveying-mapping-services', description: 'Land surveying, drone mapping, and GIS services.' },
  ...
  { id: 'waste-management-composting-services', name: 'Waste Management & Composting Services', icon: Recycle, parent: 'services', href: '/talent-exchange?category=waste-management-composting-services', description: 'Services for managing agricultural waste and creating compost.' },
