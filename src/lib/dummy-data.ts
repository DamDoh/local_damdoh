...
// This data is now fetched live from Firestore in MainDashboard.tsx and is no longer used.
...
// The data structure is now created by an internationalized factory function.
// See `getMobileHomeCategories` in `i18n-constants.ts`.
