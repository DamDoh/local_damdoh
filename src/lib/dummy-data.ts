...
export const dummyUsersData: { [key: string]: { name: string, avatarUrl?: string, role?: string, headline?: string } } = {
  ...
  'farmerJoe': { name: 'Joe\'s Family Farm', role: 'Farmer', avatarUrl: 'https://placehold.co/150x150.png' },
  'agriLogisticsCo': { name: 'AgriLogistics Co-op', role: 'Collection Agent', avatarUrl: 'https://placehold.co/150x150.png' },
  'freshFoodsProcessor': { name: 'FreshFoods Processors Ltd.', role: 'Processor', avatarUrl: 'https://placehold.co/150x150.png' },
  'globalCommoditiesTrader': { name: 'Global Commodities Trading', role: 'Trader', avatarUrl: 'https://placehold.co/150x150.png' },
  'ecoHarvestRetail': { name: 'EcoHarvest Grocers', role: 'Retailer', avatarUrl: 'https://placehold.co/150x150.png' },
  'agriTechInnovator': { name: 'Dr. Lena Hanson', role: 'Development Personnel', avatarUrl: 'https://placehold.co/150x150.png' },
  'inputSolutionsInc': { name: 'Input Solutions Inc.', role: 'Input Supplier', avatarUrl: 'https://placehold.co/150x150.png' },
  'agriProcessorSarah': { name: 'Sarah Chen - ValueChain Processors', role: 'Processor', avatarUrl: 'https://placehold.co/200x200.png' },
  ...
  'currentDemoUser': { name: "Demo User", avatarUrl: "https://placehold.co/40x40.png"},
  // For Network Page
  'sc1': { name: 'AgriLogistics Global', role: 'Trader', avatarUrl: 'https://placehold.co/150x150.png'},
  'sc2': { name: 'EcoFertilizers Ltd.', role: 'Input Supplier', avatarUrl: 'https://placehold.co/150x150.png'},
  'sc3': { name: 'Maria Silva - Coffee Cooperative', role: 'Agricultural Cooperative', avatarUrl: 'https://placehold.co/150x150.png'},
  'sc4': { name: 'TechFarm Solutions', role: 'Development Personnel', avatarUrl: 'https://placehold.co/150x150.png'},
  'sc5': { name: 'Asia Food Processors Inc.', role: 'Processor', avatarUrl: 'https://placehold.co/150x150.png'},
  'sc6': { name: 'FairHarvest Finance', role: 'Financial Institution', avatarUrl: 'https://placehold.co/150x150.png'},
  // For Talent Exchange Page
  'kenyaFreshExports': { name: 'Kenya Fresh Exports', avatarUrl: 'https://placehold.co/40x40.png' },
  'organicGrowthAdvisors': { name: 'Organic Growth Advisors', avatarUrl: 'https://placehold.co/40x40.png' },
  'agriBankCorp': { name: 'AgriBank Corp', avatarUrl: 'https://placehold.co/40x40.png' },
  'landHoldingsLLC': { name: 'Land Holdings LLC', avatarUrl: 'https://placehold.co/40x40.png' },
  'skyAgroScout': { name: 'SkyAgro Scout', avatarUrl: 'https://placehold.co/40x40.png' },
  'midwestHarvestServices': { name: 'Midwest Harvest Services', avatarUrl: 'https://placehold.co/40x40.png' },
  // For Marketplace Page
   'quinoaCoopPeru': { name: 'Quinoa Coop Peru', avatarUrl: 'https://placehold.co/40x40.png' },
  'coolHaulLogistics': { name: 'CoolHaul Logistics', avatarUrl: 'https://placehold.co/40x40.png' },
  'ecoGrowInputs': { name: 'EcoGrow Inputs', avatarUrl: 'https://placehold.co/40x40.png' },
  'seedTechResale': { name: 'SeedTech Resale', avatarUrl: 'https://placehold.co/40x40.png' },
  'sunnyAcresFarm': { name: 'Sunny Acres Farm', avatarUrl: 'https://placehold.co/40x40.png' },
  'agriPlanExperts': { name: 'AgriPlan Experts', avatarUrl: 'https://placehold.co/40x40.png' },
  // Forum topic creators
  'ethicaAgri': { name: 'Ethica Agri Group', avatarUrl: 'https://placehold.co/40x40.png'},
  'foodSaverPro': { name: 'FoodSaver Professionals', avatarUrl: 'https://placehold.co/40x40.png'},
  'marketAnalystAgri': { name: 'Agri Market Analyst', avatarUrl: 'https://placehold.co/40x40.png'},
...
export const dummySuggestedConnections: UserProfile[] = [
  { id: 'sc1', name: dummyUsersData['sc1'].name, role: 'Trader', location: 'Rotterdam Port, Netherlands', avatarUrl: dummyUsersData['sc1'].avatarUrl, profileSummary: 'Connecting European buyers with global agricultural producers. Specializing in grains, oilseeds, and sustainable commodities.', email: 'contact@agrilogistics.global'},
  { id: 'sc2', name: dummyUsersData['sc2'].name, role: 'Input Supplier', location: 'Nairobi, Kenya', avatarUrl: dummyUsersData['sc2'].avatarUrl, profileSummary: 'Provider of organic fertilizers and soil health solutions for smallholder farmers in East Africa. Seeking distribution partners.', email: 'sales@ecofertilizers.ke'},
  { id: 'sc3', name: dummyUsersData['sc3'].name, role: 'Agricultural Cooperative', location: 'Minas Gerais, Brazil', avatarUrl: dummyUsersData['sc3'].avatarUrl, profileSummary: 'Manager of a cooperative of 200+ specialty coffee farmers. Focused on direct trade and quality improvement. Seeking buyers.', email: 'maria.silva@coffeecoop.br'},
  { id: 'sc4', name: dummyUsersData['sc4'].name, role: 'Development Personnel', location: 'Silicon Valley, CA', avatarUrl: dummyUsersData['sc4'].avatarUrl, profileSummary: 'Develops and implements precision agriculture tools (drone imagery, IoT sensors) for optimizing farm inputs and yields.', email: 'info@techfarm.solutions'},
  { id: 'sc5', name: dummyUsersData['sc5'].name, role: 'Processor', location: 'Bangkok, Thailand', avatarUrl: dummyUsersData['sc5'].avatarUrl, profileSummary: 'Large-scale processor of tropical fruits and vegetables for export and local markets. Interested in sourcing from new farm clusters.', email: 'sourcing@asiafoodpro.th'},
  { id: 'sc6', name: dummyUsersData['sc6'].name, role: 'Financial Institution', location: 'London, UK', avatarUrl: dummyUsersData['sc6'].avatarUrl, profileSummary: 'Impact investment fund providing trade finance and working capital for ethical agribusinesses in developing countries.', email: 'deals@fairharvest.finance'},
];
