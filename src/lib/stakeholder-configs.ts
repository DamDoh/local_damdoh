  ...
  posts: [
    {
      ...
      verified: true,
      time: "2 hours ago",
      content: "Just harvested my first maize crop this season! The yield was better than expected thanks to the new irrigation system. [Wheat]",
      type: "general",
      likes: 24,
      comments: [],
      commentCount: 5,
  ...
  posts: [
    {
      ...
      verified: true,
      time: "4 hours ago",
      content: "Excited to announce our new low-interest loan program for smallholder farmers! Apply now for up to KSH 100,000 with flexible repayment terms. [DollarSign]",
      type: "announcement",
      likes: 45,
      comments: [],
      commentCount: 12,
  ...
  posts: [
    {
      ...
      verified: true,
      time: "6 hours ago",
      content: "Looking for high-quality maize suppliers in the Rift Valley region. Offering competitive prices and long-term contracts. [Phone] DM for details.",
      type: "market",
      likes: 18,
      comments: [],
      commentCount: 7,
  ...
  posts: [
    {
      ...
      verified: true,
      time: "3 hours ago",
      content: "Just funded a community irrigation project in Nakuru! This will benefit 50+ smallholder farmers and increase their yields by 40%. Together we're building sustainable agriculture! [Droplets][Sprout] #ImpactInvesting #SustainableFarming",
      type: "success",
      likes: 89,
      comments: [],
      commentCount: 34,
  ...
  posts: [
    {
      ...
      verified: true,
      time: "8 hours ago",
      content: "Our new AI-powered crop disease detection system is now available for beta testing! Early results show 95% accuracy in identifying common maize diseases. [Microscope]",
      type: "innovation",
      likes: 67,
      comments: [],
      commentCount: 23,
