...
export const STAKEHOLDER_ROLES = [
  ...
  'FieldAgentAgronomistDamDohInternal',
  'OperationsLogisticsTeamDamDohInternal',
  'QualityAssuranceTeamDamDohInternal',
  'ProcessingPackagingUnit',
  'BuyerRestaurantSupermarketExporter',
  'InputSupplierSeedFertilizerPesticide',
  'EquipmentSupplierSalesofMachineryIoT',
  'FinancialInstitutionMicrofinanceLoans',
  'GovernmentRegulatorAuditor',
  'CertificationBodyOrganicFairTradeetc',
  'Consumer',
  'ResearcherAcademic',
  'LogisticsPartnerThirdPartyTransporter',
  'StorageWarehouseFacility',
  'AgronomyExpertConsultantExternal',
  'AgroTourismOperator',
  'EnergySolutionsProviderSolarBiogas',
  'AgroExportFacilitatorCustomsBroker',
  'AgriTechInnovatorDeveloper',
  'WasteManagementCompostFacility',
  'CrowdfunderImpactInvestorIndividual',
  'InsuranceProvider',
  'PackagingSupplier'
] as const;
...
export const STAKEHOLDER_ICONS: Record<string, LucideIcon> = {
    'Farmer': Sprout,
    'AgriculturalCooperative': Building2,
    'FieldAgentAgronomistDamDohInternal': UserCheck,
    'OperationsLogisticsTeamDamDohInternal': Truck,
    'QualityAssuranceTeamDamDohInternal': Clipboard,
    'ProcessingPackagingUnit': Factory,
    'BuyerRestaurantSupermarketExporter': Briefcase,
    'InputSupplierSeedFertilizerPesticide': ShoppingBag,
    'EquipmentSupplierSalesofMachineryIoT': Tractor,
    'FinancialInstitutionMicrofinanceLoans': CircleDollarSign,
    'GovernmentRegulatorAuditor': Scale,
    'CertificationBodyOrganicFairTradeetc': Award,
    'Consumer': Users,
    'ResearcherAcademic': BookOpen,
    'LogisticsPartnerThirdPartyTransporter': GitBranch,
    'StorageWarehouseFacility': Warehouse,
    'AgronomyExpertConsultantExternal': GraduationCap,
    'AgroTourismOperator': Home,
    'EnergySolutionsProviderSolarBiogas': Sun,
    'AgroExportFacilitatorCustomsBroker': Globe,
    'AgriTechInnovatorDeveloper': Brain,
    'WasteManagementCompostFacility': Recycle,
    'CrowdfunderImpactInvestorIndividual': Banknote,
    'InsuranceProvider': ShieldCheck,
    'PackagingSupplier': Box,
};
