...
// 23. Equipment Supplier
export const equipmentSupplierProfileSchema = baseProfileSchema.extend({
    equipmentTypes: z.array(z.string()).optional(),
    brandsCarried: z.array(z.string()).optional(),
});

// 24. Agricultural Cooperative
export const agriculturalCooperativeProfileSchema = baseProfileSchema.extend({
  memberCount: z.number().int().positive().optional().describe("Number of members in the cooperative"),
...
export const stakeholderProfileSchemas = {
  ...
  "Agricultural Cooperative": agriculturalCooperativeProfileSchema,
