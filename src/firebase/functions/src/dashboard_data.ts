...
export const getOperationsDashboardData = functions.https.onCall(
  async (data, context): Promise<OperationsDashboardData> => {
    checkAuth(context);
    // This data would typically come from monitoring tools and log analysis.
    return {
      vtiGenerationRate: {
      ...
      flaggedEvents: [
        {
          ...
          description: 'Transport event logged 300km away from previous step within 10 minutes.',
          vtiLink: '#',
        },
      ],
    };
