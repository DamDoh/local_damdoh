          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
               ...
               <li className="flex items-start gap-3">
                <CircleDollarSign className="h-5 w-5 mt-1 text-primary" />
                <div>
                  <h4 className="font-semibold">{t('forWho.fis.title')}</h4>
                  <p className="text-sm text-muted-foreground">{t('forWho.fis.description')}</p>
                </div>
              </li>
            </ul>
          </div>
