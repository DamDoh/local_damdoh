/**
 * Energy Provider Layout Component - Specialized layout for energy providers
 * Composes energy-specific widgets and services following microservice pattern
 */
...
interface EnergyProviderLayoutProps {
  config: any; // StakeholderConfig
  feedContent?: React.ReactNode;
}

export const EnergyProviderLayout: React.FC<EnergyProviderLayoutProps> = ({ config, feedContent }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <AchievementBadges userRole="energy" />
          <WeatherWidget />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Sidebar - Energy Operations */}
        ...
        {/* Right Sidebar - Energy Solutions & Sustainability */}
        <div className="lg:col-span-3 space-y-6">
          <NewsEventsWidget />
          <CommunityCollaborationWidget />
          <TrendingTopics />
      ...
      {/* Bottom Row - Additional Energy Tools */}
