/**
 * Consumer Layout Component - Specialized layout for end consumers
 * Composes consumer-specific widgets and services following microservice pattern
 */
...
export const ConsumerLayout: React.FC<ConsumerLayoutProps> = ({ config, feedContent }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <AchievementBadges userRole="consumer" />
          <WeatherWidget />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Right Sidebar - Product Discovery & Community */}
        <div className="lg:col-span-3 space-y-6">
          <NewsEventsWidget />
          <CommunityCollaborationWidget />
          <TrendingTopics />
      ...
      {/* Bottom Row - Additional Consumer Tools */}
