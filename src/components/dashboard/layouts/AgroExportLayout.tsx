/**
 * Agro Export Layout Component - Specialized layout for agricultural exporters
 * Composes export-specific widgets and services following microservice pattern
 */
...
interface AgroExportLayoutProps {
  config: any; // StakeholderConfig
  feedContent?: React.ReactNode;
}

export const AgroExportLayout: React.FC<AgroExportLayoutProps> = ({ config, feedContent }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <AchievementBadges userRole="agroexport" />
          <WeatherWidget />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Sidebar - Export Operations */}
        ...
        {/* Right Sidebar - Export Intelligence & Compliance */}
        <div className="lg:col-span-3 space-y-6">
          <MarketIntelligenceWidget />
          <SupplyChainWidget />
          <TrendingFarmersWidget />
      ...
      {/* Bottom Row - Additional Export Tools */}
