/**
 * Equipment Supplier Layout Component - Specialized layout for agricultural equipment suppliers
 * Composes equipment-specific widgets and services following microservice pattern
 */
...
interface EquipmentSupplierLayoutProps {
  config: any; // StakeholderConfig
  feedContent?: React.ReactNode;
}

export const EquipmentSupplierLayout: React.FC<EquipmentSupplierLayoutProps> = ({ config, feedContent }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <AchievementBadges userRole="equipment" />
          <WeatherWidget />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Sidebar - Equipment Operations */}
        ...
        {/* Right Sidebar - Equipment Solutions & Support */}
        <div className="lg:col-span-3 space-y-6">
          <MarketIntelligenceWidget />
          <SupplyChainWidget />
          <TrendingFarmersWidget />
      ...
      {/* Bottom Row - Additional Equipment Tools */}
