/**
 * Logistics Layout Component - Specialized layout for logistics and transportation providers
 * Composes logistics-specific widgets and services following microservice pattern
 */
...
export const LogisticsLayout: React.FC<LogisticsLayoutProps> = ({ config, feedContent }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <AchievementBadges userRole="logistics" />
          <WeatherWidget />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Sidebar - Logistics Operations */}
        ...
        {/* Right Sidebar - Transportation & Fleet Management */}
        <div className="lg:col-span-3 space-y-6">
          <MarketIntelligenceWidget />
          <SupplyChainWidget />
          <TrendingFarmersWidget />
      ...
      {/* Bottom Row - Additional Logistics Tools */}
