/**
 * Operations Layout Component - Specialized layout for operations and management teams
 * Composes operations-specific widgets and services following microservice pattern
 */
...
export const OperationsLayout: React.FC<OperationsLayoutProps> = ({ config, feedContent }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <AchievementBadges userRole="operations" />
          <WeatherWidget />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Sidebar - Operations Management */}
        ...
        {/* Right Sidebar - Business Operations & Analytics */}
        <div className="lg:col-span-3 space-y-6">
          <NewsEventsWidget />
          <CommunityCollaborationWidget />
          <TrendingTopics />
      ...
      {/* Bottom Row - Additional Operations Tools */}
