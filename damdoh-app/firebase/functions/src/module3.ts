  ...
  try {
    ...
    const farms = farmsSnapshot.docs.map(doc => {
        ...
        return { 
            id: doc.id, 
            ...docData,
            createdAt: (docData.createdAt as admin.firestore.Timestamp)?.toDate ? (docData.createdAt as admin.firestore.Timestamp).toDate().toISOString() : null,
            updatedAt: (docData.updatedAt as admin.firestore.Timestamp)?.toDate ? (docData.updatedAt as admin.firestore.Timestamp).toDate().toISOString() : null,
        }
    });
  ...
  try {
    ...
    if (farmData.ownerId !== context.auth.uid) {
     ...
     return { 
        id: farmDoc.id, 
        ...farmData,
        createdAt: (farmData.createdAt as admin.firestore.Timestamp)?.toDate ? (farmData.createdAt as admin.firestore.Timestamp).toDate().toISOString() : null,
        updatedAt: (farmData.updatedAt as admin.firestore.Timestamp)?.toDate ? (farmData.updatedAt as admin.firestore.Timestamp).toDate().toISOString() : null,
    };
  ...
  try {
    ...
    const crops = cropsSnapshot.docs.map((doc) => {
        ...
        return { 
            id: doc.id, 
            ...docData,
            plantingDate: (docData.plantingDate as admin.firestore.Timestamp)?.toDate ? (docData.plantingDate as admin.firestore.Timestamp).toDate().toISOString() : null,
            harvestDate: (docData.harvestDate as admin.firestore.Timestamp)?.toDate ? (docData.harvestDate as admin.firestore.Timestamp).toDate().toISOString() : null,
            createdAt: (docData.createdAt as admin.firestore.Timestamp)?.toDate ? (docData.createdAt as admin.firestore.Timestamp).toDate().toISOString() : null,
        };
    });
    return crops;
