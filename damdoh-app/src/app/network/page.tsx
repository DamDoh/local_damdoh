...
import { STAKEHOLDER_ROLES, STAKEHOLDER_ICONS } from "@/lib/constants";
        ...
        <CardContent>
          ...
          {filteredConnections.length === 0 && !isLoading && (
            <div className="text-center py-10 col-span-full">
              ...
              <p className="text-sm text-muted-foreground">Try adjusting your filters or broaden your search for better supply chain connections.</p>
            </div>
          )}
        </CardContent>
      </Card>
