...
export function CreatePostModal({ isOpen, onClose, onCreatePost }: CreatePostModalProps) {
  ...
  const currentUser = profile || { name: "Demo User", photoURL: "https://placehold.co/40x40.png" };
        ...
        <DialogHeader className="p-4 border-b">
          ...
          <div className="flex items-center gap-2">
            <Avatar className="h-9 w-9">
              <AvatarImage src={currentUser.photoURL || undefined} alt={currentUser.displayName || 'User'} data-ai-hint="profile person agriculture" />
